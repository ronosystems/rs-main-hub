// /home/kk/RS/TRONIC_MASTER/frontend/src/pages/electronics/ElectronicReceipt.js

import React, { useState, useEffect } from 'react';
import { useNavigate, useLocation } from 'react-router-dom';
import MainLayout from '../../components/layout/MainLayout';
import './ElectronicReceipt.css';

const ElectronicReceipt = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const { receiptData: locationReceiptData, product, unit, branch, fromSale } = location.state || {};
  ...
  if (!product || !unit) {
    return (
      <MainLayout title="Receipt" breadcrumbs={['Home', 'Products', 'Electronics', 'Receipt']}>
  ...
  return (
    <MainLayout title="Electronic Receipt" breadcrumbs={['Home', 'Products', 'Electronics', 'Receipt']}>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    {displayData.product?.name || `${product.brand} ${product.model}`}
                    <br />
                    <span className="receipt-specs">
                      {displayData.product?.ram || product.ram || 'N/A'} | {displayData.product?.rom || product.rom || 'N/A'}
                    </span>
                    <br />
                    <span className="receipt-serial">
                      Serial: {displayData.product?.serial || unit.identifier}
                    </span>
                  </td>
