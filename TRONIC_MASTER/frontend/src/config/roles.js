...
export const ROLE_PERMISSIONS = {
  ...
  company_admin: {
    ...
    menu: [
      ...
      { path: '/reports', label: 'Reports', icon: 'Reports' },      // ✅ ADDED REPORTS
      { path: '/revenues', label: 'Revenues', icon: 'Revenues' },  // ✅ ADDED REVENUES
...
export const getRoleDisplayName = (role) => {
  return ROLE_PERMISSIONS[role]?.label || 'Staff';
};

// Helper: Get role level
export const getRoleLevel = (role) => {
  return ROLE_PERMISSIONS[role]?.level || 1;
};